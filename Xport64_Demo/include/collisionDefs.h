...
/*--------------------------------------------------------------------------*/
/*-------------------------collisioncheck.c functions-----------------------*/
/*--------------------------------------------------------------------------*/

extern void SetCollisionMesh_ENV(EnvObject* object, TriggerBox *cTrigBox, MeshCollider *cMesh, MeshColliderTri *cTri); //set various collision objects (trigger, mesh)
extern u8 wallMesh_CollisionCheck(Sphere* sphereCollider, SceneManager* currentScene); //formerly testMesh_CollisionCheck
extern u8 groundMesh_CollisionCheck(Sphere* sphereCollider, SceneManager* currentScene);

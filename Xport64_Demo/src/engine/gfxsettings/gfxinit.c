...
static Vp vp = {
	...
	//(400)*1.625, (300)*1.625, G_MAXZ/2, 0, // scale 
    //400*1.625, 300*1.625, G_MAXZ/2, 0, // translate 
	//(ANAMORPHIC_WD)*2, (SCREEN_HT)*2, G_MAXZ/2, 0, // scale 
    //(ANAMORPHIC_WD*2)-150, SCREEN_HT*2, G_MAXZ/2, 0, // translate 
};

static Vp vp_16_9 = {
	(ANAMORPHIC_WD)*2, (ANAMORPHIC_HT)*2, G_MAXZ/2, 0, // scale 
    ANAMORPHIC_WD*2, ANAMORPHIC_HT*2, G_MAXZ/2, 0, // translate 
};
...
static Vp vp_4_3 = {
	...
	(SCREEN_WD)*2, (SCREEN_HT)*2, G_MAXZ/2, 0, // scale 
    SCREEN_WD*2, SCREEN_HT*2, G_MAXZ/2, 0, // translate 
	//(Test_WD)*2, (Test_HT)*2, G_MAXZ/2, 0, // scale 
   // Test_WD*2, Test_HT*2, G_MAXZ/2, 0, // translate 
};
...
Gfx game_setup_rdpstate[] = {
	...
	//gsDPSetScissor(G_SC_NON_INTERLACE, 10,16, Test_WD,Test_HT),	
